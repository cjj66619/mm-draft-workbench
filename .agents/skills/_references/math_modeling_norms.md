...
- 论文不是工作日志。正文中不要出现内部文件名、脚本名、临时目录、工作流说明或“由 AI 生成”等过程痕迹。例外：赛事官方要求 AI 使用声明时（华为杯 2025 年官方模板已要求正文标注 + 参考文献列出 AI 工具，当届以官方通知为准），按官方格式声明，见 `huaweibei_excellent_paper_patterns.md` §1。
